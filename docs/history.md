# 0.13
* мажорная версия поднята из-за большого количества доработок, не могу гарантировать что
  формат хранения сохранился.
* поддержаны в каком-то объеме древние конфигурации и формы, для этого отказался от отдельного 
  этапа конвертации в json, теперь это делается по месту. Чуть более полная работа с вариантами формам.
...
* список вложенных объектов теперь выгружается в виде отдельного человекочитаемого файла, что позволяет динамически 
  собирать версии с нужными метаданными.

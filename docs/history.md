# 0.15
* new изменено расширение у файлов содержащих код 1С с "1с" на "bsl", как на обещепринятое - используемое
самой 1С. Для расширения bsl на github и gitlab есть подсветка синтаксиса.
* new добавлен параметр process которым можно ограничить количество используемых утилитой ядер процессора

#0.19
Добавлены динамические директивы.

В случаях когда код пишется для разных типов клиента и есть необходимость для одного и 
того же кода в одном случае указаывать директивы в другом случае не указывать.

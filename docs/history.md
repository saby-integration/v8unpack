...
## 1.2.9
* new параметр version может устанавливать версию режима совместимости и для конфигураций. Выснили, что нельзя
  установить отсутсивие режима совместимости. Это расчетное значение выводится когда текущая версия платформы 

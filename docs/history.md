### 0.6.20
 * fix работа с обычными и управляемыми формами в 803
 
### 0.6.19
 * fix проблема невалидного хеша. неправильные параметры запаковки в v8unpack

### 0.6.18
 * fix решена проблема невалидного хеша расширения конфигурации

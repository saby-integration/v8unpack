...
```
    ...
    > base - общие файлы этого расширения
      > {xyyzzz версия совместимости} - общие для этого режима совместимости
        > {код конфигурации}- общие для этой конфигурации 1С
          > {xyyzzzbbb версия конфигурации} - папка содержит файлы актуальные только для этой версии конфигурации
    > src
      > {xyyzzz версия совместимости} - папка содержит файлы актуальные только для этого режима совместимости

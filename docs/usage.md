...
```
* -XYYYZZZ - версия конфигурации 1C, первые три разряда с ведущими нулями (верю что не должно 
быть существенных изменений в каком то билде, поэтому его можно опустить. 3 знака, потому что

...
class MetaDataTypes(Enum):
    ...
    ГруппаКоманд = '1c57eabe-7349-44b3-b1de-ebfeab67b47d'
    ...
    ОбщиеКартинки = '7dcd43d9-aca5-4926-b549-1842e6a4e8cf'
    ОбщаяКоманда = '2f1a5187-fb0e-4b05-9489-dc5dd6412348'
    ОбщиеМакеты = '0c89c792-16c3-11d5-b96b-0050bae0a95d'
    ...
    Отчет = '631b75a0-29e2-11d6-a3c7-0050bae0a776'

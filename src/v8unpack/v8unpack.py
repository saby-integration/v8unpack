...
def main():
    ...
    parser.add_argument('--version',
                        help="версия режима совместимости, необязательно. "
                             ...
                             " совпадает с текущей версией платформы. При сборке обработок для старых версий"
                             " можно указать 802, чтобы принудительно коммендировать директивы в модуле объекта "
                             " даже если обработка была сохранена на современной платформе")
